...
import { ISpace, SPACE_DIRECTION, SPACE_ALIGN } from './type';
import { toLower } from 'lodash';

export function Space({ direction, align, size, children }: ISpace) {
  return (
    <SpaceWrapper direction={direction} align={align} size={size}>
      <div>스페이스 테스트</div>
      <div>스페이스 테스트2</div>
      {children}
    </SpaceWrapper>
